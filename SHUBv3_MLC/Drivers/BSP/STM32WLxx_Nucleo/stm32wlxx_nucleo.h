...
/** @defgroup STM32WLXX_NUCLEO_LOW_LEVEL_LED STM32WLXX_NUCLEO LOW LEVEL LED
 * @{
 */
...
#define BUS_BSP_LED_GPIO_PIN GPIO_PIN_11
...
#define BUS_GPIO_INSTANCE GPIO
#define BUS_BSP_BUTTON_GPIO_CLK_ENABLE() __HAL_RCC_GPIOA_CLK_ENABLE()
#define BUS_BSP_BUTTON_GPIO_PIN GPIO_PIN_0
#define BUS_BSP_BUTTON_GPIO_CLK_DISABLE() __HAL_RCC_GPIOA_CLK_DISABLE()
#define BUS_BSP_BUTTON_GPIO_PORT GPIOA
...
#define BUS_LPUART1_CTS_GPIO_AF GPIO_AF8_LPUART1
#define BUS_LPUART1_CTS_GPIO_PORT GPIOB
#define BUS_LPUART1_CTS_GPIO_CLK_ENABLE() __HAL_RCC_GPIOB_CLK_ENABLE()
#define BUS_LPUART1_CTS_GPIO_PIN GPIO_PIN_13
#define BUS_LPUART1_CTS_GPIO_CLK_DISABLE() __HAL_RCC_GPIOB_CLK_DISABLE()
#define BUS_LPUART1_RTS_GPIO_PIN GPIO_PIN_12
#define BUS_LPUART1_RTS_GPIO_PORT GPIOB
#define BUS_LPUART1_RTS_GPIO_CLK_DISABLE() __HAL_RCC_GPIOB_CLK_DISABLE()
#define BUS_LPUART1_RTS_GPIO_AF GPIO_AF8_LPUART1
#define BUS_LPUART1_RTS_GPIO_CLK_ENABLE() __HAL_RCC_GPIOB_CLK_ENABLE()
